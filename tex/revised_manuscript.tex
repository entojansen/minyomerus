...
region, setae covering 2/3 of dorsal surface area; dorsally with 7 apicomesal lacinial teeth; ventrally with 4 reduced lacinial teeth. 
		...
		\subsubsection*{Natural history}
			Associated with spear globemallow \textit{Sphaeralcea hastulata} A. Gray [non-focal] (Malvaceae [non-focal]). The indication of ``Sphaeralcea hastula A. Gray'' is not a valid name and appears to be a misspelling of \textit{Sphaeralcea hastulata}.
