...
%DIF ADD revised_manuscript.tex   Mon Jul 30 20:41:11 2018
...
\DIFdelend \DIFaddbegin \textbf{\DIFadd{USNM}}\DIFaddend }: 1 \female\DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{; }\texttt{\textbf{\DIFadd{CMNC}}}\DIFadd{: }\DIFaddend 1 \male);
		...
		\subsubsection*{Natural history}
			Associated with spear globemallow \textit{Sphaeralcea hastulata} A. Gray [non-focal] (Malvaceae [non-focal]). \DIFaddbegin \DIFadd{The indication of ``Sphaeralcea hastula A. Gray'' is not a valid name and appears to be a misspelling of }\textit{\DIFadd{Sphaeralcea hastulata}}\DIFadd{.
}\DIFaddend 
...
\section*{\DIFadd{Funding statement}}
	\DIFadd{This research was funded in part by the National Science Foundation (DEB-1155984) and the United States Department of Agriculture -- Agricultural Research Service (Agreement 58-1275-1-335).
